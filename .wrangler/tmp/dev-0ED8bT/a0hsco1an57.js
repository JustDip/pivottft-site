...
// .wrangler/tmp/bundle-zEinR0/checked-fetch.js
...
// .wrangler/tmp/bundle-zEinR0/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-JP9Cq2/functionsWorker-0.27605157785765333.mjs
...
var SITE = "https://www.pivottft.com";
var SUFFIX = " | PivotTFT";
var SECTIONS = {
...
__name(deslug, "deslug");
__name2(deslug, "deslug");
function isAppRoute(pathname) {
  const seg = pathname.split("/").filter(Boolean)[0] || "";
  return seg in SECTIONS;
}
__name(isAppRoute, "isAppRoute");
__name2(isAppRoute, "isAppRoute");
...
__name(metaForPath, "metaForPath");
__name2(metaForPath, "metaForPath");
async function onRequest(context) {
  ...
  const transformed = new HTMLRewriter().on("title", { element(e) {
    e.setInnerContent(meta.title);
  } }).on('meta[name="description"]', { element(e) {
    e.setAttribute("content", meta.desc);
  ...
  } }).on('meta[name="twitter:title"]', { element(e) {
    e.setAttribute("content", meta.title);
  } }).on('meta[name="twitter:description"]', { element(e) {
    e.setAttribute("content", meta.desc);
  } }).on('link[rel="canonical"]', { element(e) {
...
// ../../../AppData/Local/npm-cache/_npx/0eedb5afd4158ff3/node_modules/wrangler/templates/pages-dev-util.ts
...
// .wrangler/tmp/pages-JP9Cq2/a0hsco1an57.js
...
// .wrangler/tmp/bundle-zEinR0/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-zEinR0/middleware-loader.entry.ts
